...
import sys
import os
sys.path.append(os.path.abspath('/cluster/project7/ProsRegNet_CellCount/UNet_SR/model'))
from train_functions import get_scheduler, get_checkpoint_name, get_lr
